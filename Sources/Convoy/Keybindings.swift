...
final class Keybindings: ObservableObject {
    ...
    static let actions: [KeyAction] = [
        ...
        KeyAction(id: "project.tasks", title: "Tasks area", group: "Project", defaultBinding: "cmd+opt+4"),
        KeyAction(id: "project.docs", title: "Docs & specs area", group: "Project", defaultBinding: "cmd+opt+5"),
        KeyAction(id: "project.nextArea", title: "Next section (Sessions → Docs)", group: "Project", defaultBinding: "cmd+shift+]"),
        KeyAction(id: "project.previousArea", title: "Previous section", group: "Project", defaultBinding: "cmd+shift+["),
        KeyAction(id: "project.newTask", title: "New task", group: "Project", defaultBinding: "cmd+shift+n"),
