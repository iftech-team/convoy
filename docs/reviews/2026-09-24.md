...
| Medium | A late generated commit message could overwrite a reopened dialog with the same repository and draft. | Bind asynchronous UI results to the dialog lifetime. Regression tests resolve generation and file reads after closing and reopening. |
